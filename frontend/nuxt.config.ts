  ...
  runtimeConfig: {
    ...
    public: {
      ...
      googleSheetsPricingId:
        process.env.NUXT_PUBLIC_GOOGLE_SHEETS_PRICING_ID || "",
      googleSheetsApiKey: process.env.NUXT_PUBLIC_GOOGLE_SHEETS_API_KEY || "",
      bookingApiUrl: process.env.NUXT_PUBLIC_BOOKING_API_URL || "/api/booking",
    },
  },
    ...
    head: {
      ...
      meta: [
        ...
        { property: "og:type", content: "website" },
        {
          property: "og:title",
          content:
            "Академия единоборств Camelot - ММА, Бокс, БЖЖ | СПб, Парнас",
        },
        {
